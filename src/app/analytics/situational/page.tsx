...
export default async function SituationalAnalyticsPage() {
  ...
  try {
    ...
    console.error("[SituationalAnalyticsPage] fetch failed:", e);
  }

  return (
    <ArticleRubricGrid heading="Ситуативный анализ" articles={articles} />
  );
}
