...
export function MigrationBanner() {
  ...
  return (
    <div
      ...
      className="relative z-[60] border-b-2 border-gold bg-ink px-4 py-2.5 text-paper-warm"
    >
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 pr-10 text-center text-sm leading-snug sm:text-base">
        <span>
          ...
          <a
            ...
            className="font-semibold text-gold-deep underline underline-offset-2 transition hover:text-paper-warm"
            target="_blank"
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-1 text-xl leading-none text-paper-warm/70 transition hover:text-paper-warm"
      >
        ×
      </button>
    </div>
