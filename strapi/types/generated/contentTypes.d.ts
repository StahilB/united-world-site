...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content_html: Schema.Attribute.RichText &
      ...
      >;
    content_html_en: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u0430\u043D\u0430\u043B\u0438\u0437'>;
    is_global_review: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    is_translated_en: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#14213D'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalReviewGlobalReview extends Struct.SingleTypeSchema {
  collectionName: 'global_reviews';
  info: {
    description: '\u0421\u0438\u043D\u0433\u043B\u0442\u043E\u043D: \u0433\u043B\u0430\u0432\u043D\u044B\u0439 \u0433\u043B\u043E\u0431\u0430\u043B\u044C\u043D\u044B\u0439 \u043E\u0431\u0437\u043E\u0440';
    displayName: 'Global Review';
    pluralName: 'global-reviews';
    singularName: 'global-review';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global-review.global-review'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiStaticPageStaticPage extends Struct.SingleTypeSchema {
  collectionName: 'static_pages';
  info: {
    description: '\u0421\u043E\u0434\u0435\u0440\u0436\u0438\u043C\u043E\u0435 \u0441\u0442\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0445 \u0441\u0442\u0440\u0430\u043D\u0438\u0446 \u0441\u0430\u0439\u0442\u0430 (\u041E \u0446\u0435\u043D\u0442\u0440\u0435, \u041A\u043E\u043C\u0430\u043D\u0434\u0430 \u0438 \u0442.\u0434.)';
  ...
  attributes: {
    about_html: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    about_html_en: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    contacts_html: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    contacts_html_en: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    cooperation_html: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    cooperation_html_en: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    support_html: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    support_html_en: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
